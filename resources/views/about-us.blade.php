...
<x-layout title="Tentang Kami">
    <section
        class="bg-about-us-hero-section bg-cover bg-center bg-no-repeat section-padding-x text-light-base pt-32 pb-12 md:pt-48 md:pb-36 relative">
                ...
                <form action="" method="post" id="submit-contact-form">
                    ...
                    <div class="w-full">
                        <div class="relative">
                            ...
                            <textarea id="message" name="message" required="" placeholder="Masukkan pesan..." class="w-full bg-white rounded border border-gray-400 outline-none py-2 px-3 h-32"></textarea>
                        </div>
                    </div>
                    <div class="w-full">
